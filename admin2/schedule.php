    ...
    <div class="panel-body">
        ...
        <div class="tab-pane active">
            ...
            <div class="container-fluid tab-content ct-staff-right-details">
                <div class="tab-pane active member-offdays mt-10" id="member-offdays">
                        ...
                        <div class="panel panel-default">
                            <div class="col-sm-3 col-md-3 col-lg-3 col-xs-12 ct-weeks-schedule-menu">
                                <ul class="nav nav-pills nav-stacked">
                                        ...
                                        <li class="<?php if($i==1){ echo "active";}?>"><a href="#<?php echo $weeknameid[$i-1];?>" data-toggle="tab"><?php echo '';?></a></li>
                                </ul>
                            </div>
							...
							<span class="prove_schedule_type" style="visibility: hidden;"><?php echo $option[7]; ?></span>
                                    ...
                                    for ($i = $minweek; $i <= $maxweek; $i++) {
                                        ...
                                        <div class="tab-pane <?php  if($i==1 ){ echo "active";}?>" id="<?php echo $weeknameid[$i - 1];?>">
                                            <div class="panel panel-default">
                                                <div class="panel-body">
                                                    <h4 class="ct-right-header">Imposta la durata in minuti degli slot </h4>
                                                <div class="row">
                                                    <div class='col-md-3'>
                                                ...
                                                <h4 class="ct-right-header">Imposta la quantità standard di campioni di autocontrollo per il laboratorio </h4>
                                                <div class="row">
                                                    <div class='col-md-3'>
                                                        <label for="numero_campioni">Campioni</label>
                                                    ...
                                                    <?php  if($minweek==1 && $maxweek==1){ ?>
                                                        <h4 class="ct-right-header">Programmazione settimanale</h4>
                                                        <?php
                                                    }else{
                                                        ?>
                                                        <h4 class="ct-right-header">Programmazione settimanale</h4>
