...
<div id="ct-calendar-all">
	<style>
		...
		<?php
	if(!empty($_SESSION['ct_laboratorioid'])){
	?>
	<div class='container_margin' style="display: none;">
		<div class='row'>
			<div class='col-md-4'>
				<label for="select_laboratorio">Scegli il laboratorio desiderato</label>
		...
		<div class='row'>
			<div class='col-md-4'>
				<button onclick='changeLab()' class='btn btn-success form-control'>Conferma</button>
			</div>
		</div>
	</div>
	<?php
	...
	<script>
		...
		function changeLab() {
			var lab = $('#select_laboratorio').val()
			jQuery.ajax({
				type: "POST",
				data: {
					lab: lab
