...
foreach ($ufficiale as $riga) {
    echo '
          <tr>
             ...
             <td class="col-md-1">
                  <button type="button" class="btn btn-danger" onclick="remove_campione(' . $riga['id_izler_finalita'] . ')">Rimuovi</button>
              </td>
          </tr>
          ';
}
...
foreach ($autocontrollo as $row) {
    ...
    <tr>
        ...
        <td class="col-md-1">
            <button type="button" class="btn btn-danger" onclick="remove_campione(' . $row['id_izler_campione'] . ')">Rimuovi</button>
        </td>
    </tr>
    ';
}
