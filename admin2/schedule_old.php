            ...
            <div class="container-fluid tab-content ct-staff-right-details">
                <div class="tab-pane col-lg-12 col-md-12 col-sm-12 col-xs-12 active" id="member-details">
                    ...
                    $option[7] = 'weekly';
                            ...
                            <tr>
<td><span class="login_user_id" id="login_user_id" data-id="<?php echo $_SESSION['lab_selected']; ?>"></td>
                            </tr>
                            </tbody>
                        </table>
                    </div>
                                                    ...
                                                    <ul class="list-unstyled" id="ct-staff-breaks">
                                                        ...
                                                        for ($j = 1; $j <= 7; $j++) {
                                                            ...
                                                            <li class="active">
                                                                ...
                                                                {?>
                                                                    <span class="col-sm-2 col-md-2 col-lg-2 col-xs-12">
<a id="ct-add-staff-breaks" data-weekid="<?php echo $i;?>" data-staff_id="<?php echo $_SESSION['lab_selected']; ?>" data-weekday="<?php echo $j;?>"
   class="btn btn-small btn-success ct-small-br-btn myct-add-staff-breaks" data-id="<?php echo $i;?>_<?php  echo $j;?>"><?php echo $label_language_values['add_break'];?></a>
                        ...
                        <div class="panel-body">
                            <div class="ct-member-offtime-inner">
                                ...
                                <div class="col-md-2 col-sm-2 col-xs-12 col-lg-2">
                                    <a href="javascript:void(0)" id="add_break" data-id="<?php echo $_SESSION['lab_selected'];?>" class="form-group btn btn-info mt-20" name=""><?php echo $label_language_values['add_break'];?></a>
                                </div>
                            </div>
                ...
                <div class="tab-pane member-offdays mt-10" id="member-offdays">
                    <div class="panel panel-default">
                        <?php 
                        $offday->user_id=$_SESSION['lab_selected'];
                                ...
                                <div class="pull-left">
                                    <div class="ct-custom-checkbox">
                                        <ul class="ct-checkbox-list">
                                            <li>
                                                <input style="margin:0px;" type="checkbox"  class="fullmonthoff all" data-prov_id="<?php echo $_SESSION['lab_selected']; ?>" id="<?php echo $year.'-'.$this_month;?>" <?php   $offday->off_year_month=$year.'-'.$this_month;
                            ...
                            while ($i<=$insgesamt) {
                                ...
                                if (($i==$date) && ($this_month==$month_num)) {
                                    if(isset($arr_all_off_day)  && in_array($cal_cur_date, $arr_all_off_day)) {
                                        echo '<td  id="'.$year.'-'.$this_month.'-'.$i.'" data-prov_id="'.$_SESSION['lab_selected'].'" class="selectedDate RR offsingledate"  align=center >';
                                    } else {
                                        echo '<td  id="'.$year.'-'.$this_month.'-'.$i.'" data-prov_id="'.$_SESSION['lab_selected'].'"  class="date_single RR offsingledate"  align=center>';
                                    }
                                } else {
                                    if(isset($arr_all_off_day)  &&  in_array($cal_cur_date, $arr_all_off_day)) {
                                        echo '<td  id="'.$year.'-'.$this_month.'-'.$i.'"  data-prov_id="'.$_SESSION['lab_selected'].'"  class="selectedDate RR offsingledate highlight"  align=center>';
                                    } else {
                                        echo '<td  id="'.$year.'-'.$this_month.'-'.$i.'" data-prov_id="'.$_SESSION['lab_selected'].'" class="date_single RR offsingledate"  align=center>';
                                    }
                                }
