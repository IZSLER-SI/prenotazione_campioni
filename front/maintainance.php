...
$settings->conn=$conn;
$adminprofile = new prenotazione_campioni_adminprofile();
    ...
    <div id="ct" class="ct-wrapper">
		<div class="ct-container">
			...
			<?php 
				if($last!=""){
					if($last=="sna"){
						Echo "Please add atleast single service & method & unit with enable status (prenotazione_campioni->Admin->Services)";
					}elseif($last=="cna"){
						Echo "Please add your company profile data (prenotazione_campioni->Admin->Settings->Company)";
					}elseif($last=="pss"){
						Echo "Please add availability schedule (prenotazione_campioni->Admin->Schedule->availability)";
					}else{
						echo "";
					}
				}
