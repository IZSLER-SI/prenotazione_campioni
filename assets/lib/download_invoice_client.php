...
ob_start();	session_start();
	...
	$order=new prenotazione_campioni_order_client_info();
	$payments=new prenotazione_campioni_payments();	
	$general=new prenotazione_campioni_general();
	$smethod=new prenotazione_campioni_services_methods();
	$smunit=new prenotazione_campioni_services_methods_units();	
	$saddon=new prenotazione_campioni_services_addon();
