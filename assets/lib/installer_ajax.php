...
$configure = new prenotazione_campioni_configure();
?>
<script>
...
elseif(isset($_POST['add_admin']) && $_POST['add_admin'] == "1"){
	...
	<div id="cti-content" class="col-md-8 col-sm-8 col-lg-8">
		...
		<h4 class="text-success"> Woot..! prenotazione_campioni is installed and license is activated successfully !!</h4>
		<div class="cti-info"><b>Administrator's account has been successfully created.</b></div>
		<div class="cti-info">You can access prenotazione_campioni admin from <a href="admin/" target="_BLANK">here</a> and start configuring your new appointment tool.
