					...
					<div id="accordion" class="panel-group">
						<div class="ct-staff-list col-md-3 col-sm-4 col-xs-12 col-lg-3">
							<div class="ct-staff-container">
								<h3><?php echo $label_language_values['staff_members'];?> <span>(<?php echo $objadmin->countall_users();?>)</span>
								...
								<ul class="nav nav-tab nav-stacked ct-left-staff" id="sortable">
									<?php  
										$all_staff = $objadmin->readall_users();
										$i = 1;
										while($arr_staff = mysqli_fetch_array($all_staff)){
											...
											<li class="staff-list br-2 staff_click staff_<?php  echo $trigger;?> staff_c_<?php  echo $arr_staff['id'];?>" id="" data-id = "<?php echo $arr_staff['id'];?>">
												...
												<span class="ct-staff-name <?php if(empty($arr_staff['role'])){echo "missing";}?>">
												<?php 
												echo $arr_staff['fullname'];
												?></span>
												</a>
											</li>
											<?php 
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<table class="form-horizontal" cellspacing="0">
					...
					<tr class="form-field form-required">
						<td><label for="staff_role"><?php echo "Ruolo";?></label></td>
						<td>
							<select name="staff_ruolo" class="form-control" id="staff_role" required="required" />
								<option value='admin'>Amministratore</option>
								<option value='accettazione'>Utente accettazione</option>
								<option value='laboratorio'>Utente laboratorio</option>
							</select>
						</td>
					</tr>
					<!--<tr>
