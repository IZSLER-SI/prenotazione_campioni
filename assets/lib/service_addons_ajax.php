...
$conn = $con->connect();
$objservice_addon = new prenotazione_campioni_services_addon();
$objservice_addon_rate = new prenotazione_campioni_services_addon_rates();
        ...
        <li class="panel panel-default ct-clean-services-panel cta-addon-icons mysortlistaddons" id="addons_service_<?php  echo $arrs['id'];?>" data-id="<?php echo $arrs['id'];?>" data-position="<?php echo $arrs['position'];?>">
                    ...
                    <div class="pull-right cta-col5">
                        <div class="cta-col3">
                            <label for="sevice-endis-<?php echo $i; ?>">
								...
								<input class='myservices_addons_status' data-toggle="toggle" data-size="small" type='checkbox' data-id="<?php echo $arrs['id']; ?>" <?php  if ($arrs['status'] == 'E') { echo "checked='checked'"; } else { echo ""; } ?> name="myservices_addons_status" id="sevice-endis-<?php echo $i; ?>" data-on="<?php echo $label_language_values['enable'];?>" data-off="<?php echo $label_language_values['disable'];?>" data-onstyle='success' data-offstyle='danger' />
							</label>
                        </div>
                        <div class="pull-right">
                            <div class="cta-col1">
								<?php 
								$t = $objservice_addon->addons_isin_use($arrs['id']);
								if($t>0){
									?>
								...
								{
									?>
                                <a id="ct-delete-service" data-toggle="popover"
                                   class="delete-clean-service-btn pull-right btn-circle btn-danger btn-sm"
                                   rel="popover" data-placement='left' title="<?php echo $label_language_values['delete_this_addon_service'];?>"> <i class="fa fa-trash" title="<?php echo $label_language_values['delete_service'];?>"></i></a>
                                    ...
                                    <table class="form-horizontal" cellspacing="0">
                                        ...
                                        <tr>
                                            <td>
                                                ...
                                                <button id="ct-close-popover-delete-service-addon" class="btn btn-default btn-sm" href="javascript:void(0)"><?php echo $label_language_values['cancel'];?>
                                                </button>
                                            </td>
                                        </tr>
                                        </tbody>
            ...
            <div id="details_sp<?php  echo $arrs['id']; ?>" class="serviceaddon_detail panel-collapse collapse">
                <div class="panel-body">
                        ...
                        <form id="myformedt_addons_<?php  echo $arrs['id'];?>" method="post" type="" class="slide-toggle">
                            <table class="ct-create-service-table">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="col-xs-12 np"><input type="text" class="form-control txtedtaddon_title<?php  echo $arrs['id']; ?>" id="myedtaddon_title<?php  echo $arrs['id'];?>" name = "myedtaddon_titlename<?php  echo $arrs['id'];?>" value="<?php echo $arrs['addon_service_name']; ?>"/>
                                        </div>
                                    </td>
                                </tr>
								<tr>
									...
									<td>
										<div class="form-inline">
											<div class="input-group">
												...
												<input placeholder="00" size="2" maxlength="2" type="text" class="form-control txtedtaddon_hours<?php echo $arrs['id']; ?>" id="addon_edit_hours<?php echo $arrs['id'];?>" name = "myedtaddon_durationhours<?php echo $arrs['id'];?>" value="<?php echo $intval; ?>" />
												
												<span class="input-group-addon"><?php echo $label_language_values['hours'];?></span>
											</div>
											<div class="input-group cta_mt_10">

												<input placeholder="05" size="2" maxlength="2" type="text" class="form-control txtedtaddon_mints<?php echo $arrs['id']; ?>" id="addon_edit_mints<?php echo $arrs['id'];?>" name = "myedtaddon_durationmints<?php echo $arrs['id'];?>" value="<?php echo $modulas; ?>"/>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="ct-clean-service-addons-image-uploader">
                                            ...
                                            ?>
                                            <img data-imagename="" id="pcaol<?php  echo $arrs['id'];?>addonimage" src="<?php echo $imagepath;?>" class="ct-clean-service-addons-image br-100" height="100" width="100">
											<?php 
											if($arrs['image']==''){
											?>
											<label for="ct-upload-imagepcaol<?php  echo $arrs['id'];?>" class="ct-clean-service-addons-img-icon-label ser_addons<?php  echo $arrs['id'];?>">
											...
											?>
                                            <input data-us="pcaol<?php  echo $arrs['id'];?>" data-id="<?php echo $arrs['id'];?>" class="hide ct-upload-images" type="file" name="" id="ct-upload-imagepcaol<?php  echo $arrs['id'];?>" />
											<label for="ct-upload-imagepcaol<?php  echo $arrs['id'];?>" class="ct-clean-service-addons-img-icon-label addon_ser_cam cam_btn_addon<?php  echo $arrs['id'];?>">
                                                <i class="ct-camera-icon-common br-100 fa fa-camera"></i>
                                                <i class="pull-left fa fa-plus-circle fa-2x"></i>
                                            </label>
											<?php 
                                                ...
                                                <table class="form-horizontal" cellspacing="0">
                                                    ...
                                                    <tr>
                                                        <td>
                                                            ...
                                                            <a href="javascript:void(0)" id="ct-close-popover-service-image" class="btn btn-default btn-sm" href="javascript:void(0)"><?php echo $label_language_values['cancel'];?></a>
                                                        </td>
                                                    </tr>
                                                    </tbody>
                                                </table>
										...
										<span class="cta-addon-img-icon"><?php echo $label_language_values['or'];?></span>
                                                    ...
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <div class="col-md-12 col-xs-12">
                                                                <a data-us="pcaol<?php  echo $arrs['id'];?>" class="btn btn-success ct_upload_img2" data-imageinputid="ct-upload-imagepcaol<?php  echo $arrs['id'];?>" data-id="<?php echo $arrs['id'];?>" ><?php echo $label_language_values['crop_and_save'];?></a>
                                                        ...
                                                        <div class="modal-body">
                                                            <img id="ct-preview-imgpcaol<?php  echo $arrs['id'];?>" />
                                                        </div>
                                                        <div class="modal-footer">
                                                            <div class="col-md-12 np">
                                                                <div class="col-md-4 col-xs-12">
                                                                    <label class="pull-left"><?php echo $label_language_values['file_size'];?></label> <input type="text" class="form-control" id="pcaolfilesize<?php  echo $arrs['id'];?>" name="filesize" />
                                                                </div>
                                                                <div class="col-md-4 col-xs-12">
                                                                    <label class="pull-left">H</label> <input type="text" class="form-control" id="pcaol<?php  echo $arrs['id'];?>h" name="h" />
                                                                </div>
                                                                <div class="col-md-4 col-xs-12">
                                                                    <label class="pull-left">W</label> <input type="text" class="form-control" id="pcaol<?php  echo $arrs['id'];?>w" name="w" />
                                                                </div>
                                                                <!-- hidden crop params -->
                                                                <input type="hidden" id="pcaol<?php  echo $arrs['id'];?>x1" name="x1" />
                                                                <input type="hidden" id="pcaol<?php  echo $arrs['id'];?>y1" name="y1" />
                                                                <input type="hidden" id="pcaol<?php  echo $arrs['id'];?>x2" name="x2" />
                                                                <input type="hidden" id="pcaol<?php  echo $arrs['id'];?>y2" name="y2" />
                                                                <input type="hidden" id="pcaol<?php  echo $arrs['id'];?>id" name="id" value="<?php echo $arrs['id'];?>" />
                                                                <input id="pcaolctimage<?php  echo $arrs['id'];?>" type="hidden" name="ctimage" />
                                                                <input type="hidden" id="lastrecordid" value="addon_<?php  echo $arrs['id'];?>">
                                                                <input type="hidden" id="pcaol<?php  echo $arrs['id'];?>ctimagename" class="pcaolimg" name="ctimagename" value="<?php echo $arrs['image'];?>" />
                                                                <input type="hidden" id="pcaol<?php  echo $arrs['id'];?>newname" value="addon_" />
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="col-xs-12 np">
                                            <div class="input-group">
                                                <span class="input-group-addon"><?php echo $settings->get_option('ct_currency_symbol');?></span>
                                                <input type="text" id="myedtaddon_baseprice<?php  echo $arrs['id'];?>" name = "myedtaddon_baseprice<?php  echo $arrs['id'];?>" class="form-control txtedtaddon_baseprice<?php  echo $arrs['id']; ?>" placeholder="US Dollar" value="<?php echo $arrs['base_price']; ?>">
                                            </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="col-xs-12 np">
											<input type="text" class="form-control txtedtaddon_maxqty<?php  echo $arrs['id']; ?>" id="myedtaddon_maxqty<?php  echo $arrs['id'];?>" name = "myedtaddon_maxqty<?php  echo $arrs['id'];?>" value="<?php echo $arrs['maxqty']; ?>"/>
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <label for="addon-multi-qty<?php  echo $i; ?>">
											<input class='txtedtaddon_multipleqty' data-toggle="toggle" data-size="small" type='checkbox' data-id="<?php echo $arrs['id']; ?>" <?php  if ($arrs['multipleqty'] == 'Y') { echo"checked"; } else { echo ""; } ?> id="addon-multi-qty<?php  echo $i; ?>" data-on="<?php echo $label_language_values['o_n'];?>" data-off="<?php echo $label_language_values['off'];?>" data-onstyle="primary" data-offstyle="default" />
										</label>
                                    </td>
                                </tr>
								<tr>
									<td></td>
									<td>
										<a data-id="<?php echo $arrs['id']; ?>" class="btn btn-success ct-btn-width col-md-offset-4 btneditaddon_service"><?php echo $label_language_values['update'];?>
										</a>
                    ...
                    <div class="ct-service-collapse-div col-sm-12 col-md-6 col-lg-6 col-xs-12 manage-addon-price-container<?php  echo $arrs['id']; ?>" style="display:<?php    if($settings->get_option('ct_calculation_policy') == "M"){echo "none";}else{echo "block";} ?>">
                            <div class="addon-price-rules-container mt-20 ">
                                <div class="manage-unit-price-main col-sm-12 col-md-12 col-lg-12 col-xs-12">
                                    ...
                                    <ul class="myaddonspricebyqty<?php  echo $arrs['id']; ?>">
                                        <?php 
                                        $objservice_addon_rate->addon_service_id = $arrs['id'];
                                        $idss = $arrs['id'];
                                        ...
                                        while ($r = mysqli_fetch_array($result)) {
                                            ...
                                            <li class="form-group myaddon-qty_price_row<?php  echo $r['id']; ?>">
                                                <form id="myedtform_addonunits<?php  echo $r['id']; ?>">
                                                    ...
                                                    <div class="col-xs-12 col-sm-2">
                                                        <input id="myedtqty_addon<?php  echo $r['id']; ?>" name="txtedtqtyaddons_<?php  echo $r['id']; ?>" class="form-control myloadedqty_addons<?php  echo $r['id']; ?>" placeholder="1" value="<?php echo $r['unit']; ?>" type="text"/>
                                                    </div>
                                                    <div class="price-rules-select">
                                                        <select
                                                            class="form-control myloadedrules_addons<?php  echo $r['id']; ?>">
                                                    ...
                                                    <div class="col-xs-12 col-sm-3">
                                                        <input name="myedtpriceaddon" id="myedtprice_addon<?php  echo $r['id']; ?>" class="pull-left form-control myloadedprice_addons<?php  echo $r['id']; ?>" value="<?php echo $r['rate']; ?>" placeholder="<?php echo $label_language_values['price'];?>" type="text"/>
                                                    </div>
                                                    <a data-id="<?php echo $r['id']; ?>"
                                                       class="btn btn-circle btn-success  pull-left update-addon-rule myloadedbtnsave_addons"><i class="fa fa-thumbs-up"></i></a>
                                                    <a href="javascript:void(0);" data-id="<?php echo $r['id']; ?>"
                                                       class="btn btn-circle btn-danger pull-left delete-addon-rule myloadedbtndelete_addons"><i class="fa fa-trash"></i></a>
                                                </form>
                                            </li>
                                        <?php 
                                        }
                                        ...
                                        <li class="form-group">
                                            <form id="mynewaddedform_addonunits<?php  echo $arrs['id']; ?>">
                                                <label class="col-sm-2 col-xs-12" for="addon_qty_6"><?php echo $label_language_values['Quantity'];?></label>
                                                <div class="col-xs-12 col-sm-2">
                                                    <input name="mynewssqtyaddon<?php  echo $arrs['id']; ?>"
                                                           id="mynewaddedqty_addon<?php  echo $arrs['id']; ?>"
                                                           class="form-control mynewqty_addons<?php  echo $arrs['id']; ?>"
                                                           placeholder="1"
                                                           value="" type="text"/>
                                                </div>
                                                <div class="price-rules-select">
                                                    <select
                                                        class="form-control mynewrules_addons<?php  echo $arrs['id']; ?>">
                                                        <option selected value="E">=</option>
                                                        <option value="G"> &gt; </option>
                                                    </select>
                                                </div>
                                                <div class="col-xs-12 col-sm-3">
                                                    <input name="mynewsspriceaddon<?php  echo $arrs['id']; ?>"
                                                           id="mynewaddedprice_addon<?php  echo $arrs['id']; ?>"
                                                           class="pull-left form-control mynewprice_addons<?php  echo $arrs['id']; ?>"
                                                           value=""
                                                           placeholder="<?php echo $label_language_values['price'];?>" type="text"/>
                                                </div>
                        ...
                        <form id="mynewformfor_insertaddons" method="post" type="" class="slide-toggle">
                            <table class="ct-create-service-table">
                                ...
                                <tr>
                                    <td><label for="ct-service-title"><?php echo $label_language_values['addon_title'];?></label></td>
                                    <td>
                                        <div class="col-sm-6 col-xs-12 np">
											<input type="text" placeholder="<?php echo $label_language_values['addon_title'];?>" class="form-control txtaddon_title" id="mynewtitlefor_addons" name="newssssqty_addon"/></div>
                                    </td>
                                </tr>
								<tr>
									...
									<div class="form-inline dis_flex">
										<div class="input-group w-50">
											<span class="input-group-addon"><span class="glyphicon glyphicon-time"></span></span>
											<input placeholder="00" size="2" maxlength="2" type="text" placeholder="Duration hours" class="form-control txtaddon_hours" id="addon_add_hours" name="addon_add_hours" />
											
											<span class="input-group-addon"><?php echo $label_language_values['hours'];?></span>
										</div>
										<div class="input-group w-50">

											<input placeholder="05" size="2" maxlength="2" type="text" placeholder="Duration mintues" class="form-control txtaddon_mints" id="addon_add_mints" name="addon_add_mints" />
											<span class="input-group-addon"><?php echo $label_language_values['minutes'];?></span>
										</div>
									</div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="ct-clean-service-addons-image-uploader">
                                            <img id="pcaoaddonimage" src="../assets/images/default_service.png" class="ct-clean-service-addons-image br-100" height="100" width="100">
                                            <label for="ct-upload-imagepcao" class="ct-clean-service-addons-img-icon-label">
                                                <i class="ct-camera-icon-common br-100 fa fa-camera"></i>
                                                <i class="pull-left fa fa-plus-circle fa-2x"></i>
                                            </label>
                                            ...
                                            <div class="vertical-alignment-helper">
                                                <div class="modal-dialog modal-md vertical-align-center">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <div class="col-md-12 col-xs-12">
                                                                <a data-us="pcao" class="btn btn-success ct_upload_img2" data-imageinputid="ct-upload-imagepcao"><?php echo $label_language_values['crop_and_save'];?></a>
                                                                <button type="button" class="btn btn-default hidemodal" data-dismiss="modal" aria-hidden="true"><?php echo $label_language_values['cancel'];?></button>
                                                            </div>
                                                        </div>
                                                        <div class="modal-body">
                                                            <img id="ct-preview-imgpcao" />
                                                        </div>
                                                        <div class="modal-footer">
                                                            <div class="col-md-12 np">
                                                                <div class="col-md-4 col-xs-12">
                                                                    <label class="pull-left"><?php echo $label_language_values['file_size'];?></label> <input type="text" class="form-control" id="pcaofilesize" name="filesize" />
                                                                </div>
                                                                <div class="col-md-4 col-xs-12">
                                                                    <label class="pull-left">H</label> <input type="text" class="form-control" id="pcaoh" name="h" />
                                                                </div>
                                                                <div class="col-md-4 col-xs-12">
                                                                    <label class="pull-left">W</label> <input type="text" class="form-control" id="pcaow" name="w" />
                                                                </div>
                                                                <!-- hidden crop params -->
                                                                <input type="hidden" id="pcaox1" name="x1" />
                                                                <input type="hidden" id="pcaoy1" name="y1" />
                                                                <input type="hidden" id="pcaox2" name="x2" />
                                                                <input type="hidden" id="pcaoy2" name="y2" />
                                                                <input type="hidden" id="pcaoid" name="id" value="<?php echo ($objservice_addon->getlast_record_insert()+1);?>" />
                                                                <input id="pcaoctimage" type="hidden" name="ctimage" />
                                                                <input type="hidden" id="lastrecordid" value="addon_<?php  echo ($objservice_addon->getlast_record_insert()+1);?>">
                                                                <input type="hidden" id="pcaoctimagename" class="pcaoimg" name="ctimagename" value="" />
                                                                <input type="hidden" id="pcaonewname" value="addon_" />
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="col-sm-4 col-xs-12 np">
                                            <div class="input-group">
                                                <span class="input-group-addon"><?php echo $settings->get_option('ct_currency_symbol');?></span>
                                                <input type="text" class="form-control txtaddon_baseprice" placeholder="US Dollar" id="mynewbasepricefor_addons" name="newssssprice_addon">
                                            </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="col-sm-4 col-xs-12 np">
											<input type="text" placeholder="<?php echo $label_language_values['max_qty'];?>" class="form-control txtaddon_maxqty" id="mynewbasemaxqtyfor_addons" name="newssssmaxqty_addon"/></div>
                                    </td>
                                </tr>
                                <tr>
                                    <td><label for="phone-number"><?php echo $label_language_values['multiple_qty'];?></label></td>
                                    <td>
                                        <label for="addon-multi-qty0">
											<input class='txtaddon_multiple' data-toggle="toggle" data-size="small" type='checkbox' id="addon-multi-qty0" data-on="<?php echo $label_language_values['o_n'];?>" data-off="<?php echo $label_language_values['off'];?>" data-onstyle='primary' data-offstyle='default' />
										</label>
                                    </td>
                                </tr>
								<tr>
									<td></td>
									<td>
										<a name="asdad" class="btn btn-success ct-btn-width col-md-offset-4 btnaddon_save"
												type="submit"><?php echo $label_language_values['save'];?>
										</a>
										<button type="reset" id="reset_service_addons" class="btn btn-default ct-btn-width ml-30"><?php echo $label_language_values['reset'];?></button>
									</td>
								</tr>
                                </tbody>
                            </table>
...
<?php  /* echo mysqli_num_rows($res); */
    ...
    unlink(dirname(dirname(dirname(__FILE__)))."/assets/images/services/".$_POST['imagename']);	
	/* DELETE ALL ADDONS SUB RECORDS */
...
elseif (isset($_POST['operationinsert'])) {
	...
	if($cnt == 0){
		...
		$objservice_addon->add_services_addon();
...
elseif (isset($_POST['operationedit'])) {
    ...
    $objservice_addon->predefine_image = $_POST['predefineimage'];
    $objservice_addon->predefine_image_title = $_POST['predefineimage_title'];
    $objservice_addon->update_services_addon();
    /* REMOVE UNSED IMAGES FROM FOLDER */
    $used_images = $objservice->get_used_images();
    $imgarr = array();
    while($img  = mysqli_fetch_array($used_images)){
...
$result = $objservice_addon_rate->readall();
    while ($r = mysqli_fetch_array($result)) {
        ...
        <li class="form-group myaddon-qty_price_row<?php  echo $r['id']; ?>">
            <form id="myedtform_addonunits<?php  echo $r['id']; ?>">
                ...
                <div class="col-xs-12 col-sm-2">
                    <input id="myedtqty_addon<?php  echo $r['id']; ?>"
                           name="txtedtqtyaddons_<?php  echo $r['id']; ?>"
                           class="form-control myloadedqty_addons<?php  echo $r['id']; ?>"
                           placeholder="1"
                           value="<?php echo $r['unit']; ?>" type="text"/>
                </div>
                <div class="price-rules-select">
                    <select
                        class="form-control myloadedrules_addons<?php  echo $r['id']; ?>">
                ...
                <div class="col-xs-12 col-sm-3">
                    <input name="myedtpriceaddon"
                           id="myedtprice_addon<?php  echo $r['id']; ?>"
                           class="pull-left form-control myloadedprice_addons<?php  echo $r['id']; ?>"
                           value="<?php echo $r['rate']; ?>" placeholder="<?php echo $label_language_values['price'];?>"
                           type="text"/>
                </div>
                <a data-id="<?php echo $r['id']; ?>"
                   class="btn btn-circle btn-success  pull-left update-addon-rule myloadedbtnsave_addons"><i
                        class="fa fa-thumbs-up"></i></a>
                <a href="javascript:void(0);" data-id="<?php echo $r['id']; ?>"
                   class="btn btn-circle btn-danger pull-left delete-addon-rule myloadedbtndelete_addons"><i
	...
	<li class="form-group">
		<form id="mynewaddedform_addonunits<?php  echo $_POST['addon_service_id']; ?>">
			<label class="col-sm-2 col-xs-12" for="addon_qty_6"><?php echo $label_language_values['qty'];?>.</label>
			<div class="col-xs-12 col-sm-2">
				<input name="mynewssqtyaddon<?php  echo $_POST['addon_service_id']; ?>"
					   id="mynewaddedqty_addon<?php  echo $_POST['addon_service_id']; ?>"
					   class="form-control mynewqty_addons<?php  echo $_POST['addon_service_id']; ?>"
					   placeholder="1"
					   value="" type="text"/>
			</div>
			<div class="price-rules-select">
				<select
					class="form-control mynewrules_addons<?php  echo $_POST['addon_service_id']; ?>">
					<option selected value="E">=</option>
					<option value="G"> &gt; </option>
				</select>
			</div>
			<div class="col-xs-12 col-sm-3">
				<input name="mynewsspriceaddon<?php  echo $_POST['addon_service_id']; ?>"
					   id="mynewaddedprice_addon<?php  echo $_POST['addon_service_id']; ?>"
					   class="pull-left form-control mynewprice_addons<?php  echo $_POST['addon_service_id']; ?>"
					   value=""
					   placeholder="<?php echo $label_language_values['price'];?>" type="text"/>
			</div><a href="javascript:void(0);"
							data-id="<?php echo $_POST['addon_service_id']; ?>"
							data-inspector="0"
							class="btn btn-circle btn-success add-addon-price-rule form-group new-manage-price-list mybtnaddnewqty_addon"><?php echo $label_language_values['add_new'];?></a>
		</form>
	</li>
</ul>
<?php 
...
$del_image=$objservice_addon->update_image();	
	/* if($del_image){	
		unlink(dirname(dirname(__FILE__))."/images/business/".$_SESSION['b_id']."/".$_POST['image_name']);
	} */
}
