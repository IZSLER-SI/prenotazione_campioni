<?php 
include(dirname(__FILE__).'/header.php');include_once(dirname(dirname(__FILE__)).'/header.php');
...
$database->conn=$conn;
$promo = new prenotazione_campioni_promo_code();
$promo->conn = $conn;

$objfrequently = new prenotazione_campioni_frequently_discount();
$objfrequently->conn = $conn;

$sms_template = new prenotazione_campioni_sms_template();
...
$admin_profile = new prenotazione_campioni_adminprofile();
                        ...
                        <div class="panel-body pt-50 plr-10">
                            ...
                            <div class="panel-body">
                                <table class="form-inline ct-common-table" >
                                    ...
                                    <tr>
                                        <td><label><?php echo $label_language_values['sender_email_address_prenotazione_campioni_admin_email'];?></label></td>
                                        <td>
                                            <div class="form-group">
